...
class Comment(BaseModel, db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey("info_user.id"), nullable=False)  # 评论人的id
    ...
    def to_dict(self):
        resp_dict = {
            ...
            "user": User.query.get(self.user_id).to_dict(),  # 评论人的信息
...
class UserFollow(db.Model, BaseModel):
